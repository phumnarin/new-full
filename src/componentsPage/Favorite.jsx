      ...
      {(fav.length > 0) ? (
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          {fav?.map((item, index) => (
            <div
              key={index}
              className="rounded-lg border-stone-200 border-2 m-5 p-5 pb-7 relative hover:bg-gray-100 transition duration-300 ease-in-out transform hover:-translate-y-2"
            >
              <p>
