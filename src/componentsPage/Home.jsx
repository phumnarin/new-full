          ...
          {dataLine.length > 0 ? (
            <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 ">
              {dataLine?.map((item, index) => (
                <div
                  key={index}
                  className="relative rounded-lg border-stone-200 border-2 m-5 p-5 pb-7 hover:bg-gray-100 transition duration-300 ease-in-out transform hover:-translate-y-2"
                >
                  <p>
                  ...
                  <p>
                    ...
                    <a
                      href={item.url}
                      target="_blank"
                      className="block overflow-hidden text-ellipsis whitespace-nowrap hover:bg-gray-300 text-gray-700 hover:text-gray-900 font-medium py-1 px-2 rounded-md transition-colors duration-300"
                    >
                    {item.url}
                    </a>
                  </p>
